...
const CreateProductsService_1 = require("../../services/products/CreateProductsService");
...
class CreateProductsController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createProductsServices = new CreateProductsService_1.CreateProductsServices();
            if (!req.files || Object.keys(req.files).length === 0) {
                ...
                const product = yield createProductsServices.execute({
                    name,
                    price,
                    description,
